      ...
      case 3: // Create Password
        return (
          <>
            ...
            <CardFooter>
              <Button className="w-full bg-cyan-500 hover:bg-cyan-600 text-gray-900" onClick={() => setStep(4)}>
                Create Wallet
              </Button>
            </CardFooter>
          </>
          ...
          <>
            ...
            <CardFooter>
              <Link href="/dashboard" className="w-full">
                <Button className="w-full bg-cyan-500 hover:bg-cyan-600 text-gray-900">Go to My Wallet</Button>
              </Link>
            </CardFooter>
          </>
        )
